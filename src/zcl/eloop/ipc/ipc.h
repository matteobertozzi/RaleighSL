...
#define Z_IPC_TLS_CLIENT(x)          Z_CAST(z_ipc_tls_client_t, x)
...
#define z_ipc_get_server_memory(client)  (__z_ipc_get_server(Z_IPC_CLIENT(client))->memory)
