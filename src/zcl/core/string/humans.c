...
char *z_human_dtime (char *buffer, size_t bufsize, double nsec) {
  if (nsec >= 60000000000ull) {
    snprintf(buffer, bufsize, "%.2fmin", nsec / 60000000000.0);
  } else if (nsec >= 1000000000ull) {
    snprintf(buffer, bufsize, "%.2fsec", nsec / 1000000000.0);
  } else if (nsec >= 1000000ull) {
    snprintf(buffer, bufsize, "%.2fmsec", nsec / 1000000.0);
  } else if (nsec >= 1000) {
    snprintf(buffer, bufsize, "%.2fusec", nsec / 1000.0);
  } else {
...
char *z_human_time (char *buffer, size_t bufsize, uint64_t nsec) {
  return(z_human_dtime(buffer, bufsize, nsec));
}
