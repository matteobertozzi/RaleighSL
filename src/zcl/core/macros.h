...
#define Z_INT_PTR_VALUE(x)              (*Z_CONST_INT_PTR(x))
#define Z_INT8_PTR_VALUE(x)             (*Z_CONST_INT8_PTR(x))
#define Z_INT16_PTR_VALUE(x)            (*Z_CONST_INT16_PTR(x))
#define Z_INT32_PTR_VALUE(x)            (*Z_CONST_INT32_PTR(x))
#define Z_INT64_PTR_VALUE(x)            (*Z_CONST_INT64_PTR(x))

#define Z_UINT_PTR_VALUE(x)             (*Z_CONST_UINT_PTR(x))
#define Z_UINT8_PTR_VALUE(x)            (*Z_CONST_UINT8_PTR(x))
#define Z_UINT16_PTR_VALUE(x)           (*Z_CONST_UINT16_PTR(x))
#define Z_UINT32_PTR_VALUE(x)           (*Z_CONST_UINT32_PTR(x))
#define Z_UINT64_PTR_VALUE(x)           (*Z_CONST_UINT64_PTR(x))

#define Z_CONST_FLOAT_PTR(x)            Z_CONST_CAST(float, x)
#define Z_CONST_DOUBLE_PTR(x)           Z_CONST_CAST(double, x)

#define Z_FLOAT_PTR_VALUE(x)            (*Z_CONST_FLOAT_PTR(x))
#define Z_DOUBLE_PTR_VALUE(x)           (*Z_CONST_DOUBLE_PTR(x))
