...
#define Z_LOG(level, format, ...)            Z_FLOG(stderr, level, format, ##__VA_ARGS__)
#define Z_LOG_ERRNO(level, format, ...)      Z_FLOG_ERRNO(stderr, level, format, ##__VA_ARGS__)
#define Z_FLOG(fp, level, format, ...)       __Z_FLOG(fp, level, 0, format, ##__VA_ARGS__)
#define Z_FLOG_ERRNO(fp, level, format, ...) __Z_FLOG(fp, level, errno, format, ##__VA_ARGS__)
