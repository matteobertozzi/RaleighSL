...
typedef struct z_dlink_node z_dlink_node_t;
...
#define z_dlink_node(entry, type, member)     (&(Z_CAST(type, entry)->member))
...
#define z_dlink_is_linked                     z_dlink_is_not_empty
#define z_dlink_is_not_linked                 z_dlink_is_empty
