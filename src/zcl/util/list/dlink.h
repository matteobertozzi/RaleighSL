...
#define z_dlink_has_single_item(head)                                   \
  (z_dlink_front(head) == z_dlink_back(head))
...
#define __z_dlink_node_add(inew_, iprev_, inext_)           \
  do {                                                      \
    z_dlink_node_t *iprev = iprev_;                         \
    z_dlink_node_t *inext = inext_;                         \
    z_dlink_node_t *inew = inew_;                           \
    inext->prev = inew;                                     \
    inew->next = inext;                                     \
    inew->prev = iprev;                                     \
    iprev->next = inew;                                     \
...
#define __z_dlink_node_del(iprev_, inext_)                  \
  do {                                                      \
    z_dlink_node_t *iprev = iprev_;                         \
    z_dlink_node_t *inext = inext_;                         \
    inext->prev = iprev;                                    \
