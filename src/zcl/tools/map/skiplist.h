...
void *  z_skip_list_get_custom     (z_skip_list_t *self,
                                    z_compare_t key_compare,
                                    const void *key);
void *  z_skip_list_pop_custom     (z_skip_list_t *self,
                                    z_compare_t key_compare,
                                    const void *key);
...
int     z_skip_list_contains_key   (const z_skip_list_t *self, const void *key);
int     z_skip_list_contains_value (const z_skip_list_t *self, const void *key);
