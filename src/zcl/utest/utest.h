...
#define z_assert_type_equals(env, frmt, type, expected, actual)               \
  __z_assert_equals(env, frmt, (type)expected, (type)actual)

#define z_assert_type_not_equals(env, frmt, type, expected, actual)           \
  __z_assert_not_equals(env, frmt, (type)expected, (type)actual)

#define z_assert_ptr_equals(env, expected, actual)                            \
  z_assert_type_equals(env, "p", void *, expected, actual)

#define z_assert_ptr_not_equals(env, expected, actual)                        \
  __z_assert_type_not_equals(env, "p", void *, expected, actual)

#define z_assert_int_equals(env, expected, actual)                            \
  z_assert_type_equals(env, "d", int, expected, actual)

#define z_assert_int_not_equals(env, expected, actual)                        \
  __z_assert_type_not_equals(env, "d", int, expected, actual)

#define z_assert_long_equals(env, expected, actual)                           \
  z_assert_type_equals(env, "ld", long, expected, actual)

#define z_assert_long_not_equals(env, expected, actual)                       \
  __z_assert_type_not_equals(env, "ld", long, expected, actual)

#define z_assert_u16_equals(env, expected, actual)                            \
  z_assert_type_equals(env, PRIu16, uint16_t, expected, actual)

#define z_assert_u16_not_equals(env, expected, actual)                        \
  __z_assert_type_not_equals(env, PRIu16, uint16_t, expected, actual)

#define z_assert_u32_equals(env, expected, actual)                            \
  z_assert_type_equals(env, PRIu32, uint32_t, expected, actual)

#define z_assert_u32_not_equals(env, expected, actual)                        \
  __z_assert_type_not_equals(env, PRIu32, uint32_t, expected, actual)

#define z_assert_u64_equals(env, expected, actual)                            \
  z_assert_type_equals(env, PRIu64, uint64_t, expected, actual)

#define z_assert_u64_not_equals(env, expected, actual)                        \
  __z_assert_type_not_equals(env, PRIu64, uint64_t, expected, actual)
...
#define __z_assert_memcmp(env, cond, expected, expsize, actual, actsize)      \
  do {                                                                        \
    char sexp[256], sact[256];                                                \
    z_assert(env, cond,                                                       \
             "expected %s got %s",                                            \
             z_human_dblock(sexp, 256, expected, expsize),                    \
             z_human_dblock(sact, 256, actual, actsize));                     \
  } while (0)
