...
#define RALEIGHFS_ERRNO_INFO                    (0x80000000)
...
#define raleighfs_errno_is_error(errno)     (!((errno) & RALEIGHFS_ERRNO_INFO)
#define raleighfs_errno_is_info(errno)      (!!((errno) & RALEIGHFS_ERRNO_INFO))
