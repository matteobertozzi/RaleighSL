...
#define rpc_rusage_has_utime(msg)               z_bit_test((msg)->rusage_fields_bitmap, 0)
#define rpc_rusage_has_stime(msg)               z_bit_test((msg)->rusage_fields_bitmap, 1)
#define rpc_rusage_has_maxrss(msg)              z_bit_test((msg)->rusage_fields_bitmap, 2)
#define rpc_rusage_has_minflt(msg)              z_bit_test((msg)->rusage_fields_bitmap, 3)
#define rpc_rusage_has_majflt(msg)              z_bit_test((msg)->rusage_fields_bitmap, 4)
#define rpc_rusage_has_inblock(msg)             z_bit_test((msg)->rusage_fields_bitmap, 5)
#define rpc_rusage_has_oublock(msg)             z_bit_test((msg)->rusage_fields_bitmap, 6)
#define rpc_rusage_has_nvcsw(msg)               z_bit_test((msg)->rusage_fields_bitmap, 7)
#define rpc_rusage_has_nivcsw(msg)              z_bit_test((msg)->rusage_fields_bitmap, 8)
#define rpc_rusage_has_iowait(msg)              z_bit_test((msg)->rusage_fields_bitmap, 9)
#define rpc_rusage_has_ioread(msg)              z_bit_test((msg)->rusage_fields_bitmap, 10)
#define rpc_rusage_has_iowrite(msg)             z_bit_test((msg)->rusage_fields_bitmap, 11)
